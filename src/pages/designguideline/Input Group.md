...
title: Input Group
description: <style type="text/css">.fd-form__group {    margin-bottom 20px;}</style>The input group includes form inputs with add-ons that allow the user to better understand the information being entered.
date: 2019-01-28T16:57:45.433Z
tags:
  - input group
--- 
