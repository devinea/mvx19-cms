...
title: Date Picker
description: The date-picker component is an opinionated composition of the `input-group`, `popover` and `calendar` components to accomplish the UI pattern for picking a date.
date: 2019-01-28T16:57:45.245Z
tags:
  - date-picker
--- 
